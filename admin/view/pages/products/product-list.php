...
foreach ($product_list as $product_item) {
    ...
    $is_visible = $product_item['is_visible']; // Thêm dòng này để lấy giá trị trạng thái ẩn/hiện của sản phẩm

    echo '
        <tr>
            <td>' . $product_item['masanpham'] . '</td>
            ...
            <td>
                <div class="d-flex align-items-center gap-3 fs-6">
                    <a href="javascript:viewDetail(' . $product_item['masanpham'] . ')" class="text-primary" title="Xem chi tiết"><i class="bi bi-eye-fill"></i></a>
                    <a href="javascript:editProduct(' . $product_item['masanpham'] . ')" class="text-warning" title="Sửa"><i class="bi bi-pencil-fill"></i></a>
                    <a href="javascript:deleteProduct(this,' . $product_item['masanpham'] . ');" class="text-danger" title="Xóa"><i class="bi bi-trash-fill"></i></a>
                  
                </div>
            </td>
            <!-- Thẻ hiển thị/ẩn -->
            <td>
              <a href="index.php?act=toggle_visibility&id=' . $product_item['masanpham'] . '" class="text-info" title="Ẩn/Hiện">
    <i class="bi ' . ($is_visible ? 'bi-eye-fill' : 'bi-eye-slash-fill') . '"></i>
    ' . ($is_visible ? 'Ẩn' : 'Hiện') . '
</a>
